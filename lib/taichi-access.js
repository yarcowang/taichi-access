...
// setter for chainning
Access.prototype.setId = function(id) {
	this._id = id;
	return this;
}
Access.prototype.setRules = function(rules) {
	var self = this;
	rules.forEach(function(rule) {
		self._r[rule.type] = rule.permissions;
	});
...
/**
 * return anonymous user for visitor
 */
Access.prototype.anonymous = function() {
	var user = {};
	user[this._id] = 0;
	user['name'] = 'anonymous';
	user['roles'] = ['guest'];
